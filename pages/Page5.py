...
desc_msg1 = '''
    ...
    - Lazada มีอัตราการลดราคาสินค้าเฉลี่ยสูงกว่าที่ประมาณ 18.12%
    - Shopee มีอัตราการลดราคาสินค้าเฉลี่ยอยู่ที่ประมาณ 8.94%

'''
summary1 = '''
    อย่างไรก็ตาม แม้ว่า Lazada จะมีอัตราการลดราคาสูงกว่า แต่ยอดขายเฉลี่ยของ Shopee ยังคงสูงกว่ามาก โดยยอดขายเฉลี่ยของ Shopee อยู่ที่ประมาณ 121,046.79 บาท ขณะที่ Lazada มียอดขายเฉลี่ยที่ 27,300.68 บาท\n
    ดังนั้น แม้ Lazada จะมีอัตราการลดราคาสูงกว่า แต่ยอดขายของ Shopee ยังสูงกว่ามาก
'''

desc_msg2 = '''
    จากการวิเคราะห์พบว่า:\n
    - สินค้าที่มีส่วนลดสูงสุดใน **Lazada** ลดราคา **81%** และมียอดขายอยู่ที่ **25,650 บาท**
    - สินค้าที่มีส่วนลดสูงสุดใน **Shopee** ลดราคา **74%** และมียอดขายอยู่ที่ **27,900 บาท**
'''
summary2 = '''
    ดังนั้น ยอดขายของสินค้าที่มีส่วนลดสูงสุดใน Shopee สูงกว่าใน Lazada เล็กน้อย แม้ว่าระดับส่วนลดของ Lazada จะสูงกว่าก็ตาม
'''
